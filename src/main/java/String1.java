...
public class String1
{
    ...
    public String extraEnd(String str) {
        int sL = str.length(); // sL means string length to get the last postion of the stirng's last letters.
        return str.substring(sL - 2, sL) + str.substring(sL - 2, sL) + str.substring(sL - 2, sL);
    }
    ...
    public String withoutEnd(String str) {
        int eL = str.length() - 1; //end Length
        return str.substring(1, eL);
    }
    ...
    public String comboString(String a, String b) {
        ...
        if(aL > bL) {
            ...
            return "Error Both ARE THE SAME LENGTH";
        }
        else{
            return b + a + b;
        }
    ...
    public String middleThree(String str) {
        int m3 = str.length() / 2; //gets the postion of the first of the middle 3
        return str.substring(m3-1, m3 + 2);
    }
    ...
    public String extraFront(String str) {
        ...
        if (sE == 1){
            ...
            return str.substring(0, 0) + str.substring(0, 0) + str.substring(0, 0);
        }
        else {
    ...
    public String minCat(String a, String b) {
        ...
        if (aL > bL){
            int nB = aL - bL;
            return a.substring(nB, aL) + b;
        }
        else if (bL > aL){
            int nA = bL - aL;
            return b.substring(nA, bL) + a;
        }
        else{
        return "Same lengths";
        }
